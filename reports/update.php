  ...
  <div class="center">
    <div style='width:300px; display: table'>
      ...
      <form action="update.inc.php" method="POST">
        ...
        echo "<input type='date' placeholder='Date' name='nic' value='{$row['date']}' required><br>";
        echo "<input type='text' placeholder='Category' name='category' value='{$row['category']}' required><br>";
        echo "<input type='text' placeholder='Doctor ID' name='doctor_id' value='{$row['doctor_id']}' required>";
        echo "<input type='text' placeholder='Information' name='information' value='{$row['information']}' required>";
